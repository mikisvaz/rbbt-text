...
# -*- encoding: utf-8 -*-
# stub: rbbt-text 1.3.10 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.test_files = ["test/test_spaCy.rb".freeze, "test/test_helper.rb".freeze, "test/rbbt/bow/test_dictionary.rb".freeze, "test/rbbt/bow/test_bow.rb".freeze, "test/rbbt/bow/test_misc.rb".freeze, "test/rbbt/segment/test_encoding.rb".freeze, "test/rbbt/segment/test_transformed.rb".freeze, "test/rbbt/segment/test_overlaps.rb".freeze, "test/rbbt/segment/test_named_entity.rb".freeze, "test/rbbt/segment/test_corpus.rb".freeze, "test/rbbt/segment/test_range_index.rb".freeze, "test/rbbt/segment/test_annotation.rb".freeze, "test/rbbt/entity/test_document.rb".freeze, "test/rbbt/document/corpus/test_pubmed.rb".freeze, "test/rbbt/document/test_corpus.rb".freeze, "test/rbbt/document/test_annotation.rb".freeze, "test/rbbt/test_document.rb".freeze, "test/rbbt/ner/test_patterns.rb".freeze, "test/rbbt/ner/rnorm/test_tokens.rb".freeze, "test/rbbt/ner/test_ngram_prefix_dictionary.rb".freeze, "test/rbbt/ner/test_token_trieNER.rb".freeze, "test/rbbt/ner/test_finder.rb".freeze, "test/rbbt/ner/test_brat.rb".freeze, "test/rbbt/ner/test_regexpNER.rb".freeze, "test/rbbt/ner/test_g_norm_plus.rb".freeze, "test/rbbt/ner/test_rnorm.rb".freeze, "test/rbbt/ner/test_linnaeus.rb".freeze, "test/rbbt/ner/test_chemical_tagger.rb".freeze, "test/rbbt/ner/test_NER.rb".freeze, "test/rbbt/ner/test_abner.rb".freeze, "test/rbbt/ner/test_rner.rb".freeze, "test/rbbt/ner/test_oscar4.rb".freeze, "test/rbbt/ner/test_banner.rb".freeze, "test/rbbt/test_segment.rb".freeze, "test/rbbt/nlp/open_nlp/test_sentence_splitter.rb".freeze, "test/rbbt/nlp/test_nlp.rb".freeze, "test/rbbt/nlp/genia/test_sentence_splitter.rb".freeze]
